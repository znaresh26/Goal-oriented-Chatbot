...
data = {"intents": [
             ...
             {"tag": "age",
              ...
              {"tag": "greeting",
              "patterns": [ "Hi", "Hello", "Hey","sup","Heya","Dude"],
             ...
             {"tag": "questions",
              "patterns": ["admin","main","first block","old block"],
              "responses": ["Bharadwaja block is known as admin block. All the room numbers start with 1. It is the first ever created block of our college"]
             },
             {"tag": "AAT",
              "patterns": ["concept videos","techtalk"],
              "responses": ["AAT videos counts for semester end results.They can be selected from Samvidha->AAT Selection->subject"]
             },
             {"tag": "exams",
              "patterns": ["exams","semester","mids",'externals'],
              "responses": ["for every semester two mid term exams are conducted along with final semester end, the weightage goes as follows:70(SEE)+20(CIE)+10(AAT)"]
             }
